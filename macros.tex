...
% \newcommand{\required}[1]{{\color{red} #1}}
\newcommand{\update}[1]{#1}
\newcommand{\required}[1]{#1}


\newcommand{\eat}[1]{}

% \newcommand{\yell}[1]{{\color{red} \text{#1}}}
% \newcommand{\sys}{\texttt{Dove}}
\newcommand{\cegis}{\textsf{CEGIS}}
\newcommand{\eqsat}{\textsf{EQSAT}}
\newcommand{\zzz}{\texttt{\texttt{z3}}}
\newcommand{\egraph}{\textsf{e-graph}}
\newcommand{\egraphs}{\textsf{e-graphs}}
\newcommand{\eclass}{\textsf{e-class}}
\newcommand{\eclasses}{\textsf{e-classes}}
\newcommand{\enode}{\textsf{e-node}}
\newcommand{\enodes}{\textsf{e-nodes}}
...
% \newcommand{\Q}{\mathbb Q} % the rational numbers
% \newcommand{\R}{\mathbb R} % the real numbers
% \newcommand{\SR}{\mathbb S} % a semiring
% \newcommand{\T}{\mathbb T} % the tropical semiring
% %\newcommand{\C}{\mathbb C} % complex numbers
% \newcommand{\D}{\mathbf D} % bold-face D, used for generic domain
% % \newcommand{\U}{\mathbf U} % the universe
