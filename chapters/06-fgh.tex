...
In the rest of this chapter we describe our synthesis-based
...
\begin{figure*}
    ...
    \begin{figure*}
      ...
      \required{t.o. means the original program timed out after 3 hours, in which case we report the speedup against 3 hours; o.o.m. means the original program ran out of memory.}}
    ...
    \begin{figure*}
        \centering
        \includegraphics[width=.9\textwidth]{hard_bench}
        \caption{Runtime increase as a function of the data size; lower is  better.}
        \label{fig:eval:hard}
    \end{figure*}
...
%
  ...
  by the commercial DB system mentioned in this chapter. If the optimized
