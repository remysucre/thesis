\chapter{Optimizing Linear Algebra}
...
% When $\SR=\N$, then an $\N$-relation is a standard relation under bag semantics.
...
\begin{defn}{\em (Canonical Form)} An RPlan expression (as defined in Table~\ref{tPlanOps}) is {\em \textbf{canonical}} if it is a polynomial containing no isomorphic terms. 
\end{defn}{}
...
\begin{figure}
\centering
    \includegraphics[width=0.2\linewidth]{XYY} \qquad \includegraphics[width=0.23\linewidth]{assoc} \qquad 
\includegraphics[width=0.2\linewidth]{CSE} 
    \vspace{7pt}
...
We follow Tate et.al.~\cite{DBLP:journals/corr/abs-1012-1802} 
...
\begin{figure}
    \centering  \includegraphics[width=0.5\linewidth]{heavy.pdf}
...
\begin{figure}
    \centering  \includegraphics[width=0.7\linewidth]{runtime.pdf}
...
\begin{figure}
    \centering  \includegraphics[width=0.7\linewidth]{tf.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{compiletime.pdf}
...
\end{figure}{}
\begin{figure}
    \centering  \includegraphics[width=0.6\linewidth]{strategy.pdf}
...
\cite{DBLP:journals/pacmpl/KjolstadKCLA17}. 
\sys\'s cost function assumes the cost of each operator is proportional 
 to its output size. 
This is a reasonable assumption for sparse inputs, but may not hold for dense inputs.
Although
