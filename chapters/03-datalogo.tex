...
In this paper\remy{change paper to thesis.} we propose a foundation for a query language that
...
view the ICO as function from IDBs to IDBs, written as $F(J)$.\remy{Change I to J in semi-naive algorithm.}
